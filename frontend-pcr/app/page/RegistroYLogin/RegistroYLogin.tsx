...
export default function HomeContent() {
  ...
  useEffect(() => {
  const cambiarAuth = (e: Event) => {
    const customEvent = e as CustomEvent<"login" | "registro">;

    if (customEvent.detail === "registro") {
      setIsActive(true);
    } else {
      setIsActive(false);
    }
  ...
  window.addEventListener("cambiar-auth", cambiarAuth);

  return () => {
    window.removeEventListener("cambiar-auth", cambiarAuth);
  };
}, []);
  ...
  return (
    <div id="registro-login" className={styles.wrapper}>
